# Brynex Labs - Project Documentation

Welcome to the internal documentation for Brynex Labs. This docs system tracks the implementation and architecture of core features.
...
## Getting Started
To contribute to this codebase, ensure you have the following environment variables configured:
- `SMTP_HOST`
- `SMTP_USER`
- `SMTP_PASS`
- `NEXT_PUBLIC_APP_URL`
